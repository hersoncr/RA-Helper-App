...
//
// Define your TableViewController as a subclass of this class and set the fetchedResultsController.
...
//
// Once you create an NSFetchedResultsController, you CANNOT modify its @propertys.
...
// performFetch() causes the fetchedResultsController to refetch the data.
...
// Turn on the following BOOL property before making any changes in the managed object context that
